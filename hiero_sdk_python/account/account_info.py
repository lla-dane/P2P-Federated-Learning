...
class AccountInfo:
    ...
    def _from_proto(cls, proto: CryptoGetInfoResponse.AccountInfo) -> "AccountInfo":
        ...
        return cls(
            account_id=(
                AccountId._from_proto(proto.accountID) if proto.accountID else None
            ),
    ...
    def _to_proto(self) -> CryptoGetInfoResponse.AccountInfo:
        return CryptoGetInfoResponse.AccountInfo(
            ...
            proxyReceived=(
                self.proxy_received.to_tinybars() if self.proxy_received else None
            ),

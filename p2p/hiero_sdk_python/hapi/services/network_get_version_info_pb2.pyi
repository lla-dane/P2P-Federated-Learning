...
class NetworkGetVersionInfoQuery(_message.Message):
    ...
    def __init__(
        self, header: _Optional[_Union[_query_header_pb2.QueryHeader, _Mapping]] = ...
    ) -> None: ...
...
class NetworkGetVersionInfoResponse(_message.Message):
    ...
    def __init__(
        ...
        hapiProtoVersion: _Optional[
            _Union[_basic_types_pb2.SemanticVersion, _Mapping]
        ] = ...,
        hederaServicesVersion: _Optional[
            _Union[_basic_types_pb2.SemanticVersion, _Mapping]
        ] = ...,
    ) -> None: ...

...
from ..platform.event import (
    state_signature_transaction_pb2 as _state_signature_transaction_pb2,
)
...
from .auxiliary.hints import (
    hints_preprocessing_vote_pb2 as _hints_preprocessing_vote_pb2,
)
from .auxiliary.history import (
    history_proof_key_publication_pb2 as _history_proof_key_publication_pb2,
)
from .auxiliary.history import (
    history_proof_signature_pb2 as _history_proof_signature_pb2,
)
...
class Transaction(_message.Message):
    ...
    def __init__(
        self,
        body: _Optional[_Union[TransactionBody, _Mapping]] = ...,
        sigs: _Optional[_Union[_basic_types_pb2.SignatureList, _Mapping]] = ...,
        sigMap: _Optional[_Union[_basic_types_pb2.SignatureMap, _Mapping]] = ...,
        bodyBytes: _Optional[bytes] = ...,
        signedTransactionBytes: _Optional[bytes] = ...,
    ) -> None: ...
...
class TransactionBody(_message.Message):
    ...
    cryptoDeleteLiveHash: (
        _crypto_delete_live_hash_pb2.CryptoDeleteLiveHashTransactionBody
    )
    ...
    consensusCreateTopic: (
        _consensus_create_topic_pb2.ConsensusCreateTopicTransactionBody
    )
    consensusUpdateTopic: (
        _consensus_update_topic_pb2.ConsensusUpdateTopicTransactionBody
    )
    consensusDeleteTopic: (
        _consensus_delete_topic_pb2.ConsensusDeleteTopicTransactionBody
    )
    consensusSubmitMessage: (
        _consensus_submit_message_pb2.ConsensusSubmitMessageTransactionBody
    )
    ...
    token_fee_schedule_update: (
        _token_fee_schedule_update_pb2.TokenFeeScheduleUpdateTransactionBody
    )
    token_pause: _token_pause_pb2.TokenPauseTransactionBody
    token_unpause: _token_unpause_pb2.TokenUnpauseTransactionBody
    cryptoApproveAllowance: (
        _crypto_approve_allowance_pb2.CryptoApproveAllowanceTransactionBody
    )
    cryptoDeleteAllowance: (
        _crypto_delete_allowance_pb2.CryptoDeleteAllowanceTransactionBody
    )
    ...
    state_signature_transaction: (
        _state_signature_transaction_pb2.StateSignatureTransaction
    )
    hints_preprocessing_vote: (
        _hints_preprocessing_vote_pb2.HintsPreprocessingVoteTransactionBody
    )
    hints_key_publication: _hints_key_publication_pb2.HintsKeyPublicationTransactionBody
    hints_partial_signature: (
        _hints_partial_signature_pb2.HintsPartialSignatureTransactionBody
    )
    history_proof_signature: (
        _history_proof_signature_pb2.HistoryProofSignatureTransactionBody
    )
    history_proof_key_publication: (
        _history_proof_key_publication_pb2.HistoryProofKeyPublicationTransactionBody
    )
    ...
    max_custom_fees: _containers.RepeatedCompositeFieldContainer[
        _custom_fees_pb2.CustomFeeLimit
    ]
    def __init__(
        self,
        ...
        nodeAccountID: _Optional[_Union[_basic_types_pb2.AccountID, _Mapping]] = ...,
        transactionFee: _Optional[int] = ...,
        transactionValidDuration: _Optional[
            _Union[_duration_pb2.Duration, _Mapping]
        ] = ...,
        generateRecord: bool = ...,
        memo: _Optional[str] = ...,
        batch_key: _Optional[_Union[_basic_types_pb2.Key, _Mapping]] = ...,
        contractCall: _Optional[
            _Union[_contract_call_pb2.ContractCallTransactionBody, _Mapping]
        ] = ...,
        contractCreateInstance: _Optional[
            _Union[_contract_create_pb2.ContractCreateTransactionBody, _Mapping]
        ] = ...,
        contractUpdateInstance: _Optional[
            _Union[_contract_update_pb2.ContractUpdateTransactionBody, _Mapping]
        ] = ...,
        cryptoAddLiveHash: _Optional[
            _Union[_crypto_add_live_hash_pb2.CryptoAddLiveHashTransactionBody, _Mapping]
        ] = ...,
        cryptoCreateAccount: _Optional[
            _Union[_crypto_create_pb2.CryptoCreateTransactionBody, _Mapping]
        ] = ...,
        cryptoDelete: _Optional[
            _Union[_crypto_delete_pb2.CryptoDeleteTransactionBody, _Mapping]
        ] = ...,
        cryptoDeleteLiveHash: _Optional[
            _Union[
                _crypto_delete_live_hash_pb2.CryptoDeleteLiveHashTransactionBody,
                _Mapping,
            ]
        ] = ...,
        cryptoTransfer: _Optional[
            _Union[_crypto_transfer_pb2.CryptoTransferTransactionBody, _Mapping]
        ] = ...,
        cryptoUpdateAccount: _Optional[
            _Union[_crypto_update_pb2.CryptoUpdateTransactionBody, _Mapping]
        ] = ...,
        fileAppend: _Optional[
            _Union[_file_append_pb2.FileAppendTransactionBody, _Mapping]
        ] = ...,
        fileCreate: _Optional[
            _Union[_file_create_pb2.FileCreateTransactionBody, _Mapping]
        ] = ...,
        fileDelete: _Optional[
            _Union[_file_delete_pb2.FileDeleteTransactionBody, _Mapping]
        ] = ...,
        fileUpdate: _Optional[
            _Union[_file_update_pb2.FileUpdateTransactionBody, _Mapping]
        ] = ...,
        systemDelete: _Optional[
            _Union[_system_delete_pb2.SystemDeleteTransactionBody, _Mapping]
        ] = ...,
        systemUndelete: _Optional[
            _Union[_system_undelete_pb2.SystemUndeleteTransactionBody, _Mapping]
        ] = ...,
        contractDeleteInstance: _Optional[
            _Union[_contract_delete_pb2.ContractDeleteTransactionBody, _Mapping]
        ] = ...,
        freeze: _Optional[_Union[_freeze_pb2.FreezeTransactionBody, _Mapping]] = ...,
        consensusCreateTopic: _Optional[
            _Union[
                _consensus_create_topic_pb2.ConsensusCreateTopicTransactionBody,
                _Mapping,
            ]
        ] = ...,
        consensusUpdateTopic: _Optional[
            _Union[
                _consensus_update_topic_pb2.ConsensusUpdateTopicTransactionBody,
                _Mapping,
            ]
        ] = ...,
        consensusDeleteTopic: _Optional[
            _Union[
                _consensus_delete_topic_pb2.ConsensusDeleteTopicTransactionBody,
                _Mapping,
            ]
        ] = ...,
        consensusSubmitMessage: _Optional[
            _Union[
                _consensus_submit_message_pb2.ConsensusSubmitMessageTransactionBody,
                _Mapping,
            ]
        ] = ...,
        uncheckedSubmit: _Optional[
            _Union[_unchecked_submit_pb2.UncheckedSubmitBody, _Mapping]
        ] = ...,
        tokenCreation: _Optional[
            _Union[_token_create_pb2.TokenCreateTransactionBody, _Mapping]
        ] = ...,
        tokenFreeze: _Optional[
            _Union[
                _token_freeze_account_pb2.TokenFreezeAccountTransactionBody, _Mapping
            ]
        ] = ...,
        tokenUnfreeze: _Optional[
            _Union[
                _token_unfreeze_account_pb2.TokenUnfreezeAccountTransactionBody,
                _Mapping,
            ]
        ] = ...,
        tokenGrantKyc: _Optional[
            _Union[_token_grant_kyc_pb2.TokenGrantKycTransactionBody, _Mapping]
        ] = ...,
        tokenRevokeKyc: _Optional[
            _Union[_token_revoke_kyc_pb2.TokenRevokeKycTransactionBody, _Mapping]
        ] = ...,
        tokenDeletion: _Optional[
            _Union[_token_delete_pb2.TokenDeleteTransactionBody, _Mapping]
        ] = ...,
        tokenUpdate: _Optional[
            _Union[_token_update_pb2.TokenUpdateTransactionBody, _Mapping]
        ] = ...,
        tokenMint: _Optional[
            _Union[_token_mint_pb2.TokenMintTransactionBody, _Mapping]
        ] = ...,
        tokenBurn: _Optional[
            _Union[_token_burn_pb2.TokenBurnTransactionBody, _Mapping]
        ] = ...,
        tokenWipe: _Optional[
            _Union[_token_wipe_account_pb2.TokenWipeAccountTransactionBody, _Mapping]
        ] = ...,
        tokenAssociate: _Optional[
            _Union[_token_associate_pb2.TokenAssociateTransactionBody, _Mapping]
        ] = ...,
        tokenDissociate: _Optional[
            _Union[_token_dissociate_pb2.TokenDissociateTransactionBody, _Mapping]
        ] = ...,
        scheduleCreate: _Optional[
            _Union[_schedule_create_pb2.ScheduleCreateTransactionBody, _Mapping]
        ] = ...,
        scheduleDelete: _Optional[
            _Union[_schedule_delete_pb2.ScheduleDeleteTransactionBody, _Mapping]
        ] = ...,
        scheduleSign: _Optional[
            _Union[_schedule_sign_pb2.ScheduleSignTransactionBody, _Mapping]
        ] = ...,
        token_fee_schedule_update: _Optional[
            _Union[
                _token_fee_schedule_update_pb2.TokenFeeScheduleUpdateTransactionBody,
                _Mapping,
            ]
        ] = ...,
        token_pause: _Optional[
            _Union[_token_pause_pb2.TokenPauseTransactionBody, _Mapping]
        ] = ...,
        token_unpause: _Optional[
            _Union[_token_unpause_pb2.TokenUnpauseTransactionBody, _Mapping]
        ] = ...,
        cryptoApproveAllowance: _Optional[
            _Union[
                _crypto_approve_allowance_pb2.CryptoApproveAllowanceTransactionBody,
                _Mapping,
            ]
        ] = ...,
        cryptoDeleteAllowance: _Optional[
            _Union[
                _crypto_delete_allowance_pb2.CryptoDeleteAllowanceTransactionBody,
                _Mapping,
            ]
        ] = ...,
        ethereumTransaction: _Optional[
            _Union[_ethereum_transaction_pb2.EthereumTransactionBody, _Mapping]
        ] = ...,
        node_stake_update: _Optional[
            _Union[_node_stake_update_pb2.NodeStakeUpdateTransactionBody, _Mapping]
        ] = ...,
        util_prng: _Optional[
            _Union[_util_prng_pb2.UtilPrngTransactionBody, _Mapping]
        ] = ...,
        token_update_nfts: _Optional[
            _Union[_token_update_nfts_pb2.TokenUpdateNftsTransactionBody, _Mapping]
        ] = ...,
        nodeCreate: _Optional[
            _Union[_node_create_pb2.NodeCreateTransactionBody, _Mapping]
        ] = ...,
        nodeUpdate: _Optional[
            _Union[_node_update_pb2.NodeUpdateTransactionBody, _Mapping]
        ] = ...,
        nodeDelete: _Optional[
            _Union[_node_delete_pb2.NodeDeleteTransactionBody, _Mapping]
        ] = ...,
        tokenReject: _Optional[
            _Union[_token_reject_pb2.TokenRejectTransactionBody, _Mapping]
        ] = ...,
        tokenAirdrop: _Optional[
            _Union[_token_airdrop_pb2.TokenAirdropTransactionBody, _Mapping]
        ] = ...,
        tokenCancelAirdrop: _Optional[
            _Union[
                _token_cancel_airdrop_pb2.TokenCancelAirdropTransactionBody, _Mapping
            ]
        ] = ...,
        tokenClaimAirdrop: _Optional[
            _Union[_token_claim_airdrop_pb2.TokenClaimAirdropTransactionBody, _Mapping]
        ] = ...,
        state_signature_transaction: _Optional[
            _Union[_state_signature_transaction_pb2.StateSignatureTransaction, _Mapping]
        ] = ...,
        hints_preprocessing_vote: _Optional[
            _Union[
                _hints_preprocessing_vote_pb2.HintsPreprocessingVoteTransactionBody,
                _Mapping,
            ]
        ] = ...,
        hints_key_publication: _Optional[
            _Union[
                _hints_key_publication_pb2.HintsKeyPublicationTransactionBody, _Mapping
            ]
        ] = ...,
        hints_partial_signature: _Optional[
            _Union[
                _hints_partial_signature_pb2.HintsPartialSignatureTransactionBody,
                _Mapping,
            ]
        ] = ...,
        history_proof_signature: _Optional[
            _Union[
                _history_proof_signature_pb2.HistoryProofSignatureTransactionBody,
                _Mapping,
            ]
        ] = ...,
        history_proof_key_publication: _Optional[
            _Union[
                _history_proof_key_publication_pb2.HistoryProofKeyPublicationTransactionBody,
                _Mapping,
            ]
        ] = ...,
        history_proof_vote: _Optional[
            _Union[_history_proof_vote_pb2.HistoryProofVoteTransactionBody, _Mapping]
        ] = ...,
        crs_publication: _Optional[
            _Union[_crs_publication_pb2.CrsPublicationTransactionBody, _Mapping]
        ] = ...,
        atomic_batch: _Optional[_Union[AtomicBatchTransactionBody, _Mapping]] = ...,
        max_custom_fees: _Optional[
            _Iterable[_Union[_custom_fees_pb2.CustomFeeLimit, _Mapping]]
        ] = ...,
    ) -> None: ...

...
class ContractCreateTransactionBody(_message.Message):
    __slots__ = ("fileID", "initcode", "adminKey", "gas", "initialBalance", "proxyAccountID", "autoRenewPeriod", "constructorParameters", "shardID", "realmID", "newRealmAdminKey", "memo", "max_automatic_token_associations", "auto_renew_account_id", "staked_account_id", "staked_node_id", "decline_reward")

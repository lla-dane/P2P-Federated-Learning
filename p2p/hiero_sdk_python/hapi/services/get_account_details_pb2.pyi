...
class GetAccountDetailsResponse(_message.Message):
    ...
    class AccountDetails(_message.Message):
        ...
        token_relationships: _containers.RepeatedCompositeFieldContainer[
            _basic_types_pb2.TokenRelationship
        ]
        memo: str
        owned_nfts: int
        ...
        alias: bytes
        ledger_id: bytes
        granted_crypto_allowances: _containers.RepeatedCompositeFieldContainer[
            GrantedCryptoAllowance
        ]
        granted_nft_allowances: _containers.RepeatedCompositeFieldContainer[
            GrantedNftAllowance
        ]
        granted_token_allowances: _containers.RepeatedCompositeFieldContainer[
            GrantedTokenAllowance
        ]
        def __init__(
            self,
            account_id: _Optional[_Union[_basic_types_pb2.AccountID, _Mapping]] = ...,
            contract_account_id: _Optional[str] = ...,
            deleted: bool = ...,
            proxy_account_id: _Optional[
                _Union[_basic_types_pb2.AccountID, _Mapping]
            ] = ...,
            proxy_received: _Optional[int] = ...,
            key: _Optional[_Union[_basic_types_pb2.Key, _Mapping]] = ...,
            balance: _Optional[int] = ...,
            receiver_sig_required: bool = ...,
            expiration_time: _Optional[
                _Union[_timestamp_pb2.Timestamp, _Mapping]
            ] = ...,
            auto_renew_period: _Optional[
                _Union[_duration_pb2.Duration, _Mapping]
            ] = ...,
            token_relationships: _Optional[
                _Iterable[_Union[_basic_types_pb2.TokenRelationship, _Mapping]]
            ] = ...,
            memo: _Optional[str] = ...,
            owned_nfts: _Optional[int] = ...,
            max_automatic_token_associations: _Optional[int] = ...,
            alias: _Optional[bytes] = ...,
            ledger_id: _Optional[bytes] = ...,
            granted_crypto_allowances: _Optional[
                _Iterable[_Union[GrantedCryptoAllowance, _Mapping]]
            ] = ...,
            granted_nft_allowances: _Optional[
                _Iterable[_Union[GrantedNftAllowance, _Mapping]]
            ] = ...,
            granted_token_allowances: _Optional[
                _Iterable[_Union[GrantedTokenAllowance, _Mapping]]
            ] = ...,
        ) -> None: ...

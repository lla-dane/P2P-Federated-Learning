...
class TransactionGetReceiptResponse(_message.Message):
    ...
    duplicateTransactionReceipts: _containers.RepeatedCompositeFieldContainer[
        _transaction_receipt_pb2.TransactionReceipt
    ]
    child_transaction_receipts: _containers.RepeatedCompositeFieldContainer[
        _transaction_receipt_pb2.TransactionReceipt
    ]
    def __init__(
        self,
        ...
        duplicateTransactionReceipts: _Optional[
            _Iterable[_Union[_transaction_receipt_pb2.TransactionReceipt, _Mapping]]
        ] = ...,
        child_transaction_receipts: _Optional[
            _Iterable[_Union[_transaction_receipt_pb2.TransactionReceipt, _Mapping]]
        ] = ...,
    ) -> None: ...

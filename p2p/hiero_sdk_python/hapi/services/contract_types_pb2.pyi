...
class EvmTransactionResult(_message.Message):
    ...
    def __init__(
        self,
        sender_id: _Optional[_Union[_basic_types_pb2.AccountID, _Mapping]] = ...,
        contract_id: _Optional[_Union[_basic_types_pb2.ContractID, _Mapping]] = ...,
        result_data: _Optional[bytes] = ...,
        error_message: _Optional[str] = ...,
        gas_used: _Optional[int] = ...,
        internal_call_context: _Optional[_Union[InternalCallContext, _Mapping]] = ...,
    ) -> None: ...
...
class ContractLoginfo(_message.Message):
    ...
    def __init__(
        ...
        bloom: _Optional[bytes] = ...,
        topic: _Optional[_Iterable[bytes]] = ...,
...
class ContractFunctionResult(_message.Message):
    ...
    createdContractIDs: _containers.RepeatedCompositeFieldContainer[
        _basic_types_pb2.ContractID
    ]
    ...
    def __init__(
        self,
        contractID: _Optional[_Union[_basic_types_pb2.ContractID, _Mapping]] = ...,
        contractCallResult: _Optional[bytes] = ...,
        errorMessage: _Optional[str] = ...,
        bloom: _Optional[bytes] = ...,
        gasUsed: _Optional[int] = ...,
        logInfo: _Optional[_Iterable[_Union[ContractLoginfo, _Mapping]]] = ...,
        createdContractIDs: _Optional[
            _Iterable[_Union[_basic_types_pb2.ContractID, _Mapping]]
        ] = ...,
        evm_address: _Optional[_Union[_wrappers_pb2.BytesValue, _Mapping]] = ...,
        gas: _Optional[int] = ...,
        amount: _Optional[int] = ...,
        functionParameters: _Optional[bytes] = ...,
        sender_id: _Optional[_Union[_basic_types_pb2.AccountID, _Mapping]] = ...,
        contract_nonces: _Optional[
            _Iterable[_Union[ContractNonceInfo, _Mapping]]
        ] = ...,
        signer_nonce: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ...,
    ) -> None: ...

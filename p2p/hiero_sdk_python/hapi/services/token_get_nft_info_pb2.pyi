...
class TokenGetNftInfoQuery(_message.Message):
    ...
    def __init__(
        ...
        nftID: _Optional[_Union[_basic_types_pb2.NftID, _Mapping]] = ...,
    ) -> None: ...
...
class TokenNftInfo(_message.Message):
    ...
    def __init__(
        ...
        creationTime: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
        metadata: _Optional[bytes] = ...,
        ledger_id: _Optional[bytes] = ...,
        spender_id: _Optional[_Union[_basic_types_pb2.AccountID, _Mapping]] = ...,
    ) -> None: ...
...
class TokenGetNftInfoResponse(_message.Message):
    ...
    def __init__(
        ...
        nft: _Optional[_Union[TokenNftInfo, _Mapping]] = ...,
    ) -> None: ...

...
class RealmID(_message.Message):
    ...
    realmNum: int
    def __init__(
        self, shardNum: _Optional[int] = ..., realmNum: _Optional[int] = ...
    ) -> None: ...
...
class TokenID(_message.Message):
    ...
    def __init__(
        self,
        shardNum: _Optional[int] = ...,
        realmNum: _Optional[int] = ...,
        tokenNum: _Optional[int] = ...,
    ) -> None: ...
...
class NftID(_message.Message):
    ...
    def __init__(
        self,
        token_ID: _Optional[_Union[TokenID, _Mapping]] = ...,
...
class TransactionID(_message.Message):
    ...
    def __init__(
        self,
        transactionValidStart: _Optional[
            _Union[_timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        accountID: _Optional[_Union[AccountID, _Mapping]] = ...,
        scheduled: bool = ...,
        nonce: _Optional[int] = ...,
    ) -> None: ...

class AccountAmount(_message.Message):
    __slots__ = ("accountID", "amount", "is_approval")
    ACCOUNTID_FIELD_NUMBER: _ClassVar[int]
...
class TransferList(_message.Message):
    ...
    def __init__(
        self,
        accountAmounts: _Optional[_Iterable[_Union[AccountAmount, _Mapping]]] = ...,
    ) -> None: ...

class NftTransfer(_message.Message):
    __slots__ = ("senderAccountID", "receiverAccountID", "serialNumber", "is_approval")
    ...
    def __init__(
        self,
        senderAccountID: _Optional[_Union[AccountID, _Mapping]] = ...,
        receiverAccountID: _Optional[_Union[AccountID, _Mapping]] = ...,
        serialNumber: _Optional[int] = ...,
        is_approval: bool = ...,
    ) -> None: ...
...
class TokenTransferList(_message.Message):
    ...
    def __init__(
        self,
        token: _Optional[_Union[TokenID, _Mapping]] = ...,
        transfers: _Optional[_Iterable[_Union[AccountAmount, _Mapping]]] = ...,
        nftTransfers: _Optional[_Iterable[_Union[NftTransfer, _Mapping]]] = ...,
        expected_decimals: _Optional[_Union[_wrappers_pb2.UInt32Value, _Mapping]] = ...,
    ) -> None: ...
...
class Key(_message.Message):
    ...
    def __init__(
        self,
        contractID: _Optional[_Union[ContractID, _Mapping]] = ...,
        ed25519: _Optional[bytes] = ...,
        RSA_3072: _Optional[bytes] = ...,
        ECDSA_384: _Optional[bytes] = ...,
        thresholdKey: _Optional[_Union[ThresholdKey, _Mapping]] = ...,
        keyList: _Optional[_Union[KeyList, _Mapping]] = ...,
        ECDSA_secp256k1: _Optional[bytes] = ...,
        delegatable_contract_id: _Optional[_Union[ContractID, _Mapping]] = ...,
    ) -> None: ...
...
class ThresholdKey(_message.Message):
    ...
    def __init__(
        ...
        keys: _Optional[_Union[KeyList, _Mapping]] = ...,
    ) -> None: ...
...
class KeyList(_message.Message):
    ...
    def __init__(
        self, keys: _Optional[_Iterable[_Union[Key, _Mapping]]] = ...
    ) -> None: ...
...
class Signature(_message.Message):
    ...
    def __init__(
        self,
        contract: _Optional[bytes] = ...,
        ed25519: _Optional[bytes] = ...,
        RSA_3072: _Optional[bytes] = ...,
        ECDSA_384: _Optional[bytes] = ...,
        thresholdSignature: _Optional[_Union[ThresholdSignature, _Mapping]] = ...,
        signatureList: _Optional[_Union[SignatureList, _Mapping]] = ...,
    ) -> None: ...
...
class ThresholdSignature(_message.Message):
    ...
    sigs: SignatureList
    def __init__(
        self, sigs: _Optional[_Union[SignatureList, _Mapping]] = ...
    ) -> None: ...
...
class SignatureList(_message.Message):
    ...
    def __init__(
        self, sigs: _Optional[_Iterable[_Union[Signature, _Mapping]]] = ...
    ) -> None: ...
...
class SignatureMap(_message.Message):
    ...
    def __init__(
        self, sigPair: _Optional[_Iterable[_Union[SignaturePair, _Mapping]]] = ...
    ) -> None: ...
...
class TransactionFeeSchedule(_message.Message):
    ...
    def __init__(
        self,
        hederaFunctionality: _Optional[_Union[HederaFunctionality, str]] = ...,
        feeData: _Optional[_Union[FeeData, _Mapping]] = ...,
        fees: _Optional[_Iterable[_Union[FeeData, _Mapping]]] = ...,
    ) -> None: ...
...
class FeeData(_message.Message):
    ...
    def __init__(
        self,
        nodedata: _Optional[_Union[FeeComponents, _Mapping]] = ...,
        networkdata: _Optional[_Union[FeeComponents, _Mapping]] = ...,
        servicedata: _Optional[_Union[FeeComponents, _Mapping]] = ...,
        subType: _Optional[_Union[SubType, str]] = ...,
    ) -> None: ...
...
class FeeSchedule(_message.Message):
    ...
    transactionFeeSchedule: _containers.RepeatedCompositeFieldContainer[
        TransactionFeeSchedule
    ]
    expiryTime: _timestamp_pb2.TimestampSeconds
    def __init__(
        self,
        transactionFeeSchedule: _Optional[
            _Iterable[_Union[TransactionFeeSchedule, _Mapping]]
        ] = ...,
        expiryTime: _Optional[_Union[_timestamp_pb2.TimestampSeconds, _Mapping]] = ...,
    ) -> None: ...
...
class CurrentAndNextFeeSchedule(_message.Message):
    ...
    def __init__(
        self,
        currentFeeSchedule: _Optional[_Union[FeeSchedule, _Mapping]] = ...,
        nextFeeSchedule: _Optional[_Union[FeeSchedule, _Mapping]] = ...,
    ) -> None: ...
...
class NodeAddress(_message.Message):
    ...
    def __init__(
        self,
        ipAddress: _Optional[bytes] = ...,
        portno: _Optional[int] = ...,
        memo: _Optional[bytes] = ...,
        RSA_PubKey: _Optional[str] = ...,
        nodeId: _Optional[int] = ...,
        nodeAccountId: _Optional[_Union[AccountID, _Mapping]] = ...,
        nodeCertHash: _Optional[bytes] = ...,
        serviceEndpoint: _Optional[_Iterable[_Union[ServiceEndpoint, _Mapping]]] = ...,
...
class NodeAddressBook(_message.Message):
    ...
    def __init__(
        self, nodeAddress: _Optional[_Iterable[_Union[NodeAddress, _Mapping]]] = ...
    ) -> None: ...
...
class ServicesConfigurationList(_message.Message):
    ...
    def __init__(
        self, nameValue: _Optional[_Iterable[_Union[Setting, _Mapping]]] = ...
    ) -> None: ...
...
class TokenRelationship(_message.Message):
    ...
    def __init__(
        self,
        tokenId: _Optional[_Union[TokenID, _Mapping]] = ...,
        symbol: _Optional[str] = ...,
        balance: _Optional[int] = ...,
        kycStatus: _Optional[_Union[TokenKycStatus, str]] = ...,
        freezeStatus: _Optional[_Union[TokenFreezeStatus, str]] = ...,
...
class TokenBalances(_message.Message):
    ...
    def __init__(
        self, tokenBalances: _Optional[_Iterable[_Union[TokenBalance, _Mapping]]] = ...
    ) -> None: ...
...
class TokenAssociation(_message.Message):
    ...
    def __init__(
        self,
        token_id: _Optional[_Union[TokenID, _Mapping]] = ...,
        account_id: _Optional[_Union[AccountID, _Mapping]] = ...,
    ) -> None: ...
...
class StakingInfo(_message.Message):
    ...
    def __init__(
        self,
        decline_reward: bool = ...,
        stake_period_start: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
        pending_reward: _Optional[int] = ...,
        staked_to_me: _Optional[int] = ...,
        staked_account_id: _Optional[_Union[AccountID, _Mapping]] = ...,
        staked_node_id: _Optional[int] = ...,
    ) -> None: ...
...
class PendingAirdropId(_message.Message):
    ...
    def __init__(
        self,
        sender_id: _Optional[_Union[AccountID, _Mapping]] = ...,
        receiver_id: _Optional[_Union[AccountID, _Mapping]] = ...,
        fungible_token_type: _Optional[_Union[TokenID, _Mapping]] = ...,
        non_fungible_token: _Optional[_Union[NftID, _Mapping]] = ...,
    ) -> None: ...

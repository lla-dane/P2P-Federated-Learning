...
class AccountAmount(_message.Message):
    ...
    amount: int
    is_approval: bool
    def __init__(self, accountID: _Optional[_Union[AccountID, _Mapping]] = ..., amount: _Optional[int] = ..., is_approval: bool = ...) -> None: ...
...
class NftTransfer(_message.Message):
    ...
    serialNumber: int
    is_approval: bool
    def __init__(self, senderAccountID: _Optional[_Union[AccountID, _Mapping]] = ..., receiverAccountID: _Optional[_Union[AccountID, _Mapping]] = ..., serialNumber: _Optional[int] = ..., is_approval: bool = ...) -> None: ...

...
class FractionalFee(_message.Message):
    ...
    def __init__(
        self,
        fractional_amount: _Optional[_Union[_basic_types_pb2.Fraction, _Mapping]] = ...,
        minimum_amount: _Optional[int] = ...,
        maximum_amount: _Optional[int] = ...,
        net_of_transfers: bool = ...,
    ) -> None: ...
...
class FixedFee(_message.Message):
    ...
    def __init__(
        ...
        denominating_token_id: _Optional[
            _Union[_basic_types_pb2.TokenID, _Mapping]
        ] = ...,
    ) -> None: ...
...
class RoyaltyFee(_message.Message):
    ...
    def __init__(
        self,
        exchange_value_fraction: _Optional[
            _Union[_basic_types_pb2.Fraction, _Mapping]
        ] = ...,
        fallback_fee: _Optional[_Union[FixedFee, _Mapping]] = ...,
    ) -> None: ...
...
class CustomFee(_message.Message):
    ...
    def __init__(
        self,
        fixed_fee: _Optional[_Union[FixedFee, _Mapping]] = ...,
        fractional_fee: _Optional[_Union[FractionalFee, _Mapping]] = ...,
        royalty_fee: _Optional[_Union[RoyaltyFee, _Mapping]] = ...,
        fee_collector_account_id: _Optional[
...
class AssessedCustomFee(_message.Message):
    ...
    fee_collector_account_id: _basic_types_pb2.AccountID
    effective_payer_account_id: _containers.RepeatedCompositeFieldContainer[
        _basic_types_pb2.AccountID
    ]
    def __init__(
        self,
        amount: _Optional[int] = ...,
        ...
        effective_payer_account_id: _Optional[
            _Iterable[_Union[_basic_types_pb2.AccountID, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class FixedCustomFeeList(_message.Message):
    ...
    def __init__(
        self, fees: _Optional[_Iterable[_Union[FixedCustomFee, _Mapping]]] = ...
    ) -> None: ...
...
class FeeExemptKeyList(_message.Message):
    ...
    def __init__(
        self, keys: _Optional[_Iterable[_Union[_basic_types_pb2.Key, _Mapping]]] = ...
    ) -> None: ...
...
class CustomFeeLimit(_message.Message):
    ...
    def __init__(
        ...
        fees: _Optional[_Iterable[_Union[FixedFee, _Mapping]]] = ...,
    ) -> None: ...

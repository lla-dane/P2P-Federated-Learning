...
class ProofKey(_message.Message):
    ...
    key: bytes
    def __init__(
        self, node_id: _Optional[int] = ..., key: _Optional[bytes] = ...
    ) -> None: ...
...
class HistoryProof(_message.Message):
    ...
    def __init__(
        self,
        source_address_book_hash: _Optional[bytes] = ...,
        target_proof_keys: _Optional[_Iterable[_Union[ProofKey, _Mapping]]] = ...,
        target_history: _Optional[_Union[History, _Mapping]] = ...,
        proof: _Optional[bytes] = ...,
    ) -> None: ...
...
class HistoryProofConstruction(_message.Message):
    ...
    def __init__(
        ...
        source_proof: _Optional[_Union[HistoryProof, _Mapping]] = ...,
        target_roster_hash: _Optional[bytes] = ...,
        grace_period_end_time: _Optional[
            _Union[_timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        assembly_start_time: _Optional[
            _Union[_timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        target_proof: _Optional[_Union[HistoryProof, _Mapping]] = ...,
...
class HistoryProofVote(_message.Message):
    ...
    def __init__(
        self,
        proof: _Optional[_Union[HistoryProof, _Mapping]] = ...,
...
class HistorySignature(_message.Message):
    ...
    def __init__(
        self,
        history: _Optional[_Union[History, _Mapping]] = ...,
...
class RecordedHistorySignature(_message.Message):
    ...
    def __init__(
        self,
        signing_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
        history_signature: _Optional[_Union[HistorySignature, _Mapping]] = ...,
    ) -> None: ...

...
class Query(_message.Message):
    ...
    cryptogetAccountBalance: (
        _crypto_get_account_balance_pb2.CryptoGetAccountBalanceQuery
    )
    cryptoGetAccountRecords: (
        _crypto_get_account_records_pb2.CryptoGetAccountRecordsQuery
    )
    ...
    transactionGetFastRecord: (
        _transaction_get_fast_record_pb2.TransactionGetFastRecordQuery
    )
    ...
    tokenGetAccountNftInfos: (
        _token_get_account_nft_infos_pb2.TokenGetAccountNftInfosQuery
    )
    ...
    networkGetExecutionTime: (
        _network_get_execution_time_pb2.NetworkGetExecutionTimeQuery
    )
    accountDetails: _get_account_details_pb2.GetAccountDetailsQuery
    def __init__(
        self,
        getByKey: _Optional[_Union[_get_by_key_pb2.GetByKeyQuery, _Mapping]] = ...,
        getBySolidityID: _Optional[
            _Union[_get_by_solidity_id_pb2.GetBySolidityIDQuery, _Mapping]
        ] = ...,
        contractCallLocal: _Optional[
            _Union[_contract_call_local_pb2.ContractCallLocalQuery, _Mapping]
        ] = ...,
        contractGetInfo: _Optional[
            _Union[_contract_get_info_pb2.ContractGetInfoQuery, _Mapping]
        ] = ...,
        contractGetBytecode: _Optional[
            _Union[_contract_get_bytecode_pb2.ContractGetBytecodeQuery, _Mapping]
        ] = ...,
        ContractGetRecords: _Optional[
            _Union[_contract_get_records_pb2.ContractGetRecordsQuery, _Mapping]
        ] = ...,
        cryptogetAccountBalance: _Optional[
            _Union[
                _crypto_get_account_balance_pb2.CryptoGetAccountBalanceQuery, _Mapping
            ]
        ] = ...,
        cryptoGetAccountRecords: _Optional[
            _Union[
                _crypto_get_account_records_pb2.CryptoGetAccountRecordsQuery, _Mapping
            ]
        ] = ...,
        cryptoGetInfo: _Optional[
            _Union[_crypto_get_info_pb2.CryptoGetInfoQuery, _Mapping]
        ] = ...,
        cryptoGetLiveHash: _Optional[
            _Union[_crypto_get_live_hash_pb2.CryptoGetLiveHashQuery, _Mapping]
        ] = ...,
        cryptoGetProxyStakers: _Optional[
            _Union[_crypto_get_stakers_pb2.CryptoGetStakersQuery, _Mapping]
        ] = ...,
        fileGetContents: _Optional[
            _Union[_file_get_contents_pb2.FileGetContentsQuery, _Mapping]
        ] = ...,
        fileGetInfo: _Optional[
            _Union[_file_get_info_pb2.FileGetInfoQuery, _Mapping]
        ] = ...,
        transactionGetReceipt: _Optional[
            _Union[_transaction_get_receipt_pb2.TransactionGetReceiptQuery, _Mapping]
        ] = ...,
        transactionGetRecord: _Optional[
            _Union[_transaction_get_record_pb2.TransactionGetRecordQuery, _Mapping]
        ] = ...,
        transactionGetFastRecord: _Optional[
            _Union[
                _transaction_get_fast_record_pb2.TransactionGetFastRecordQuery, _Mapping
            ]
        ] = ...,
        consensusGetTopicInfo: _Optional[
            _Union[_consensus_get_topic_info_pb2.ConsensusGetTopicInfoQuery, _Mapping]
        ] = ...,
        networkGetVersionInfo: _Optional[
            _Union[_network_get_version_info_pb2.NetworkGetVersionInfoQuery, _Mapping]
        ] = ...,
        tokenGetInfo: _Optional[
            _Union[_token_get_info_pb2.TokenGetInfoQuery, _Mapping]
        ] = ...,
        scheduleGetInfo: _Optional[
            _Union[_schedule_get_info_pb2.ScheduleGetInfoQuery, _Mapping]
        ] = ...,
        tokenGetAccountNftInfos: _Optional[
            _Union[
                _token_get_account_nft_infos_pb2.TokenGetAccountNftInfosQuery, _Mapping
            ]
        ] = ...,
        tokenGetNftInfo: _Optional[
            _Union[_token_get_nft_info_pb2.TokenGetNftInfoQuery, _Mapping]
        ] = ...,
        tokenGetNftInfos: _Optional[
            _Union[_token_get_nft_infos_pb2.TokenGetNftInfosQuery, _Mapping]
        ] = ...,
        networkGetExecutionTime: _Optional[
            _Union[
                _network_get_execution_time_pb2.NetworkGetExecutionTimeQuery, _Mapping
            ]
        ] = ...,
        accountDetails: _Optional[
            _Union[_get_account_details_pb2.GetAccountDetailsQuery, _Mapping]
        ] = ...,
    ) -> None: ...

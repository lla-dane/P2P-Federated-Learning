...
class NetworkGetExecutionTimeQuery(_message.Message):
    ...
    transaction_ids: _containers.RepeatedCompositeFieldContainer[
        _basic_types_pb2.TransactionID
    ]
    def __init__(
        self,
        header: _Optional[_Union[_query_header_pb2.QueryHeader, _Mapping]] = ...,
        transaction_ids: _Optional[
            _Iterable[_Union[_basic_types_pb2.TransactionID, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class NetworkGetExecutionTimeResponse(_message.Message):
    ...
    def __init__(
        ...
        execution_times: _Optional[_Iterable[int]] = ...,
    ) -> None: ...

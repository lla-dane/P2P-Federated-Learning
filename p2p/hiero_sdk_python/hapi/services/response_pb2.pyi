...
class Response(_message.Message):
    ...
    cryptogetAccountBalance: (
        _crypto_get_account_balance_pb2.CryptoGetAccountBalanceResponse
    )
    cryptoGetAccountRecords: (
        _crypto_get_account_records_pb2.CryptoGetAccountRecordsResponse
    )
    ...
    transactionGetFastRecord: (
        _transaction_get_fast_record_pb2.TransactionGetFastRecordResponse
    )
    ...
    tokenGetAccountNftInfos: (
        _token_get_account_nft_infos_pb2.TokenGetAccountNftInfosResponse
    )
    ...
    networkGetExecutionTime: (
        _network_get_execution_time_pb2.NetworkGetExecutionTimeResponse
    )
    accountDetails: _get_account_details_pb2.GetAccountDetailsResponse
    def __init__(
        self,
        getByKey: _Optional[_Union[_get_by_key_pb2.GetByKeyResponse, _Mapping]] = ...,
        getBySolidityID: _Optional[
            _Union[_get_by_solidity_id_pb2.GetBySolidityIDResponse, _Mapping]
        ] = ...,
        contractCallLocal: _Optional[
            _Union[_contract_call_local_pb2.ContractCallLocalResponse, _Mapping]
        ] = ...,
        contractGetBytecodeResponse: _Optional[
            _Union[_contract_get_bytecode_pb2.ContractGetBytecodeResponse, _Mapping]
        ] = ...,
        contractGetInfo: _Optional[
            _Union[_contract_get_info_pb2.ContractGetInfoResponse, _Mapping]
        ] = ...,
        contractGetRecordsResponse: _Optional[
            _Union[_contract_get_records_pb2.ContractGetRecordsResponse, _Mapping]
        ] = ...,
        ...
        cryptoGetInfo: _Optional[
            _Union[_crypto_get_info_pb2.CryptoGetInfoResponse, _Mapping]
        ] = ...,
        cryptoGetLiveHash: _Optional[
            _Union[_crypto_get_live_hash_pb2.CryptoGetLiveHashResponse, _Mapping]
        ] = ...,
        cryptoGetProxyStakers: _Optional[
            _Union[_crypto_get_stakers_pb2.CryptoGetStakersResponse, _Mapping]
        ] = ...,
        fileGetContents: _Optional[
            _Union[_file_get_contents_pb2.FileGetContentsResponse, _Mapping]
        ] = ...,
        fileGetInfo: _Optional[
            _Union[_file_get_info_pb2.FileGetInfoResponse, _Mapping]
        ] = ...,
        transactionGetReceipt: _Optional[
            _Union[_transaction_get_receipt_pb2.TransactionGetReceiptResponse, _Mapping]
        ] = ...,
        transactionGetRecord: _Optional[
            _Union[_transaction_get_record_pb2.TransactionGetRecordResponse, _Mapping]
        ] = ...,
        ...
        consensusGetTopicInfo: _Optional[
            _Union[
                _consensus_get_topic_info_pb2.ConsensusGetTopicInfoResponse, _Mapping
            ]
        ] = ...,
        networkGetVersionInfo: _Optional[
            _Union[
                _network_get_version_info_pb2.NetworkGetVersionInfoResponse, _Mapping
            ]
        ] = ...,
        tokenGetInfo: _Optional[
            _Union[_token_get_info_pb2.TokenGetInfoResponse, _Mapping]
        ] = ...,
        scheduleGetInfo: _Optional[
            _Union[_schedule_get_info_pb2.ScheduleGetInfoResponse, _Mapping]
        ] = ...,
        ...
        tokenGetNftInfo: _Optional[
            _Union[_token_get_nft_info_pb2.TokenGetNftInfoResponse, _Mapping]
        ] = ...,
        tokenGetNftInfos: _Optional[
            _Union[_token_get_nft_infos_pb2.TokenGetNftInfosResponse, _Mapping]
        ] = ...,
        ...
        accountDetails: _Optional[
            _Union[_get_account_details_pb2.GetAccountDetailsResponse, _Mapping]
        ] = ...,
    ) -> None: ...

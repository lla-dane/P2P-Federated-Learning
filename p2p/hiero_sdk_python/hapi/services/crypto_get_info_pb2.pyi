...
class CryptoGetInfoResponse(_message.Message):
    ...
    class AccountInfo(_message.Message):
        ...
        liveHashes: _containers.RepeatedCompositeFieldContainer[
            _crypto_add_live_hash_pb2.LiveHash
        ]
        tokenRelationships: _containers.RepeatedCompositeFieldContainer[
        ...
        def __init__(
            self,
            accountID: _Optional[_Union[_basic_types_pb2.AccountID, _Mapping]] = ...,
            contractAccountID: _Optional[str] = ...,
            deleted: bool = ...,
            proxyAccountID: _Optional[
                _Union[_basic_types_pb2.AccountID, _Mapping]
            ] = ...,
            proxyReceived: _Optional[int] = ...,
            key: _Optional[_Union[_basic_types_pb2.Key, _Mapping]] = ...,
            balance: _Optional[int] = ...,
            generateSendRecordThreshold: _Optional[int] = ...,
            generateReceiveRecordThreshold: _Optional[int] = ...,
            receiverSigRequired: bool = ...,
            ...
            liveHashes: _Optional[
                _Iterable[_Union[_crypto_add_live_hash_pb2.LiveHash, _Mapping]]
            ] = ...,
            tokenRelationships: _Optional[
                _Iterable[_Union[_basic_types_pb2.TokenRelationship, _Mapping]]
            ] = ...,
            memo: _Optional[str] = ...,
            ownedNfts: _Optional[int] = ...,
            max_automatic_token_associations: _Optional[int] = ...,
            alias: _Optional[bytes] = ...,
            ledger_id: _Optional[bytes] = ...,
            ethereum_nonce: _Optional[int] = ...,
            staking_info: _Optional[
                _Union[_basic_types_pb2.StakingInfo, _Mapping]
            ] = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        accountInfo: _Optional[
            _Union[CryptoGetInfoResponse.AccountInfo, _Mapping]
        ] = ...,
    ) -> None: ...

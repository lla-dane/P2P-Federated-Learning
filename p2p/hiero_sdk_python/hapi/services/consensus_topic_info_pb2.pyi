...
class ConsensusTopicInfo(_message.Message):
    ...
    fee_exempt_key_list: _containers.RepeatedCompositeFieldContainer[
        _basic_types_pb2.Key
    ]
    custom_fees: _containers.RepeatedCompositeFieldContainer[
        _custom_fees_pb2.FixedCustomFee
    ]
    def __init__(
        self,
        memo: _Optional[str] = ...,
        runningHash: _Optional[bytes] = ...,
        ...
        submitKey: _Optional[_Union[_basic_types_pb2.Key, _Mapping]] = ...,
        ...
        fee_exempt_key_list: _Optional[
            _Iterable[_Union[_basic_types_pb2.Key, _Mapping]]
        ] = ...,
        custom_fees: _Optional[
            _Iterable[_Union[_custom_fees_pb2.FixedCustomFee, _Mapping]]
        ] = ...,
    ) -> None: ...
